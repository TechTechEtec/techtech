...
// try{
//     $auth = $service->createAuth();
//     echo 'User has been created! A confirmation link has been sent to the '. $auth;
// }
// catch(Exception $e){
//     echo $auth->getError();
// }
        ...
        <div class="relative flex items-center justify-between h-16">
          ...
          <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
            <div class="flex-shrink-0 flex items-center">
              <img class="block lg:hidden h-8 w-auto" src="./public/assets/techtechlogo.svg" alt="Workflow">
              <img class="hidden lg:block h-12 w-auto" src="./public/assets/techtechlogo.svg" alt="Workflow">
            </div>
