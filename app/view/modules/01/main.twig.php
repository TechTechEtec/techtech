    ...
    <section class="w-full h-auto flex flex-col items-center justify-start">
       <div class="w-full flex items-center justify-center my-[3rem]" data-aos="fade-up">
        ...
        <div class="items-center justify-center p-4 2sm:px-2 w-full lg:w-[60rem]">    
            ...
            <img class="" src="{{BASE}}imgs/mindMap/MindMap-01.png" alt="Mapa mental Lógica de Programação" data-aos="fade-up">


            <div class="w-full items-center justify-center md:justify-end gap-[1rem] mt-[2rem]">
                <a href="{{BASE}}imgs/mindMap/MindMap-01.png" download class="font-bold text-lg flex flex-row gap-[1rem] items-center justify-center text-eerie dark:text-grey">
