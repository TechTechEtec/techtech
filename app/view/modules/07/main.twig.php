...
<section class="w-full h-auto flex flex-col items-center justify-center bg-[url({{BASE}}svgs/Random_shit.svg)] bg-repeat bg-center">
       ...
       <div class="items-center justify-center w-[25rem] lg:w-[60rem] md:w-[40rem] bg-white">     
            ...
            <div class="flex flex-row">
                <a href="{{BASE}}modules/07/exam"><p class="flex justify-center items-center font-mukta font-bold"><sl-icon-button name="file-text" label="Edit" style="font-size: 2.5rem;"></sl-icon-button>Exame <sl-icon name="arrow-right-short"></sl-icon></p></a>
            </div>
            ...
            <div class="flex flex-row gap-x-3 lg:gap-x-96 md:gap-x-96 font-mukta font-bold text-2xl justify-center items-center text-blue mt-[2rem]">
                <p class="justify-center items-center"><a href="{{BASE}}modules/06"><sl-icon name="arrow-bar-left"></sl-icon> Anterior</a></p>
            </div>
        </div>
</section>
