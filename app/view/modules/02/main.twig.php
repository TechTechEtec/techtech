...
{% block title %} Módulo 2 | Techtech {% endblock %}
...
{% block main %}
    ...
    <section class="w-full h-auto flex flex-col items-center justify-center">
       ...
       <div class="items-center justify-center p-4 2sm:px-2 w-full lg:w-[60rem]">
            ...
            <img src="{{BASE}}imgs/mindMap/MindMap-02.png" alt="Mapa mental Dados na Programação" data-aos="fade-up">

            <div class="w-full flex items-center justify-center md:justify-end gap-[1rem] mt-[2rem]">
                <a href="{{BASE}}imgs/mindMap/MindMap-02.png" download class="font-bold text-lg flex flex-row gap-[1rem] items-center justify-center text-eerie dark:text-grey" >
            ...
            <div class="flex flex-col flex-wrap mt-8">
                ...
                <div class="flex flex-row gap-x-3 lg:gap-x-11 md:gap-x-96 font-mukta font-bold text-3xl text-[#0284c7] justify-center items-center text-blue mt-[2rem]">
                     <a class="flex justify-center items-center" href="{{BASE}}modules/01"><sl-icon name="arrow-bar-left"></sl-icon> Anterior</a>
                     <a class="flex justify-center items-center" href="{{BASE}}modules/03">Próximo <sl-icon name="arrow-bar-right"></sl-icon></a>
                 </div>
            </div>
        </div>
    </section>
