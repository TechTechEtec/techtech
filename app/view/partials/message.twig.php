...
<div class="w-screen h-screen flex flex-col items-center justify-center bg-[rgba(0,0,0,0.5)] p-4 fixed z-50">
    <main class="w-[85%] md:w-[500px] h-min rounded-md  bg-[#f9f9ff] dark:bg-lighteerie text-eerie dark:text-grey drop-shadow-xl p-8 border-2 border-double border-purple flex flex-col items-start justify-center gap-8">
