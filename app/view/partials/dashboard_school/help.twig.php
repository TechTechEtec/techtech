...
<h1 class="text-5xl font-nerko text-darkpurple flex item-center justify-center">Ajuda</h1>
    <h2 class="text-3xl mt-2 font-bold dark:text-pink-500">Ajuda - Escolas e Professores</h2>
     ...
     <div class="flex flex-col gap-y-[4rem]">
            ...
            <div class="flex flex-col gap-y-[1rem] items-center justify-center">
                <p class="text-xl font-bold dark:text-white"> <p>Onde eu crio uma turma?</p>
                <span data-tilt><img src="{{BASE}}imgs/M.png"></span>
            </div>

            <div class="flex flex-col gap-y-[1rem] items-center justify-center">
                <p class="text-xl font-bold dark:text-white"> <p>Onde eu excluo uma turma?</p>
                <span data-tilt><img src="{{BASE}}imgs/M.png"></span>
            </div>

            <div class="flex flex-col gap-y-[1rem] items-center justify-center">
                <p class="text-xl font-bold dark:text-white"> <p>Onde eu posso ver os dados de uma turma?</p>
                <span data-tilt><img src="{{BASE}}imgs/M.png"></span>
            </div>
