...
<h1 class="text-5xl font-nerko text-darkpurple flex item-center justify-center">Ajuda</h1>
    <h2 class="text-3xl mt-2 font-bold dark:text-pink-500">Ajuda - Estudantes</h2>
     ...
     <div class="flex flex-col gap-y-[4rem]">
            <div class="flex flex-col gap-y-[1rem] items-center justify-center">
                ...
                <span data-tilt><img src="{{BASE}}imgs/Mmapamental.png"></span>
            </div>
            ...
            <div class="flex flex-col gap-y-[1rem] items-center justify-center">
                ...
                <span data-tilt><img src="{{BASE}}imgs/Msenha.png"></span>
            </div>
     </div>
</section>
