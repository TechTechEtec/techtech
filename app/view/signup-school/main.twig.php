...
{% block body %}
    ...
    <div class="w-screen h-screen bg-[url({{BASE}}imgs/background.png)] bg-contain bg-no-repeat bg-center bg-darkerPurple relative overflow-x-hidden flex flex-row items-start md:items-center justify-center p-4">
        ...
        <main class="flex flex-wrap space-y-2 gap-4 rounded-md items-start justify-center bg-white px-4 py-8 shadow-lg w-full max-w-[600px] min-h-[350px]" data-aos="fade-up" data-aos-mirror="true" data-aos-once="true" data-aos-duration="800">
