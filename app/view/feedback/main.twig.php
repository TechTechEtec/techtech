...
<div class="w-screen h-screen bg-[url({{BASE}}imgs/background.png)] bg-contain bg-no-repeat bg-center bg-lightpurple relative overflow-x-hidden flex flex-row items-center justify-center px-6 py-4 overflow-y-auto md:overflow-y-[none]">

    <a title="Início" href="{{BASE}}" class="text-4xl text-purple absolute top-[10px] left-[10px]">
        <sl-icon name="arrow-left-square"></sl-icon>
    </a>
 
    <div class="w-full text-xl md:text-lg flex flex-col items-center justify-start md:flex-row md:items-center md:justify-center gap-[4rem] flex-wrap mt-[8rem] md:mt-0">
        ...
        <div class="flex flex-col flex-1 items-center justify-center bg-white rounded-md shadow-lg w-full sm:w-[80%] md:w-[500px] p-6" data-aos="fade-up">
            ...
            <form method="post" class="mt-2 font-bold flex flex-col w-full">
                ...
                <label for="email" class="my-2">E-mail Institucional</label>
                <input class="bg-grey rounded-md h-10 w-full"
                id="name"
                type="email"
                name="name"
                ...
                <label for="mensagem" class="my-2">Feedback</label>
                <textarea placeholder="Sua mensagem..." rows="5" class="bg-grey rounded-md h-[100px] max-h-[100px] min-h-[100px] w-full bg-white" required></textarea>
