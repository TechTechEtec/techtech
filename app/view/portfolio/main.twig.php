...
{% block body %} 
  ...
  <footer class="bg-darkerpurple bg-[url({{BASE}}/svgs/Random_shit.svg)] shadow-xl flex flex-col-reverse lg:flex-row flex-wrap justify-evenly items-center w-screen m-0 h-auto gap-10 md:gap-4 p-6">
    <!-- Logo -->
