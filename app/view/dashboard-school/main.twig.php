        ...
        <sl-tab-group id="tab-group">
            ...
            <sl-tab-panel name="turmas">
                ...
                <div class="flex justify-start mt-4">
                    <div class="flex gap-[35rem] justify-around rounded-sm bg-white drop-shadow-lg w-[900px] h-[50px] items-center">
                        <button class="bg-lightpurple rounded-md w-[115px] h-[30px] drop-shadow-lg">
                            <span class="font-nerko font-bold text-2xl">Nova +</span>
                        </button>
                        <input class="rounded-sm h-[1.8rem] w-[10.5rem]"
                        type="text"
                        >                    
                    </div>
                </div>

                <div class="flex gap-[10rem] justify-start mt-[5rem]">
                ...
                <div class="flex justify-start mt-6">
                    <div class="grid gap-[10rem] grid-cols-4 grid-row-4">
                        <div class="space-y-8">
